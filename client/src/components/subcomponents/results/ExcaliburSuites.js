...
import ExcaliburPhotoModal from '../results/ExcaliburModal';

// arguments received: this.props.pricing, this.state
//===============================================================================================//

export default function ExcaliburSuites(pricing, state, handleSubmit, setState) {
    return (
                ...
                <Row>
                    <Col id="thumbResult" sm={4} md={4}>
                        <div className="thumbPhoto">
                            <img alt="excaliburPreview" onClick={()=>state({ excaliburShow: true })} src="https://static.pexels.com/photos/53577/hotel-architectural-tourism-travel-53577.jpeg" />
                            <ExcaliburPhotoModal show={state.excaliburShow} onHide={()=>setState({ excaliburShow: false })} />
                        </div>
                    </Col>
                    <Col id="highlightResult" sm={8} md={8}>
                        <div>
                            <p className="alignLeft">Excalibur</p>
                            <p className="alignRight">From ${(pricing.bachelorSuite).toFixed(2)}/night</p>
                        </div>
                        ...
                        <Button bsStyle="default" block onClick={ ()=> setState({ expandExcaliburView: !state.expandExcaliburView })}>
                            See available rooms
                        </Button>
                        <Panel collapsible expanded={state.expandExcaliburView}>
                            <div>
                                <div>
                                    ...
                                    <p className="roomExpandedRightButton">
                                        <Button bsStyle="success" value="executiveSuite" onClick={handleSubmit}>Book now</Button>
                                    </p>
                                </div>
                            ...
                            <div>
                                <div>
                                    ...
                                    <p className="roomExpandedRightButton">
                                        <Button bsStyle="success" value="bachelorSuite" onClick={handleSubmit}>Book now</Button>
                                    </p>
                                </div>
                                <div className="roomDescription">
                                    <p>
